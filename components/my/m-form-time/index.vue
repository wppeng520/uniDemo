...
<script>
	export default {
		...
		mounted() {
			...
			this.activeValue = [timeobj.year - 2020, timeobj.month - 1, timeobj.day - 1,timeobj.hour,timeobj.minute];
		...
		methods: {
			...
			tapConfirm() {
				...
				let timeShow =
					`${this.years[this.activeValue[0]]}年${this.months[this.activeValue[1]]}月${this.days[this.activeValue[2]]}日 ${this.hours[this.activeValue[3]]}:${this.minutes[this.activeValue[4]]}`
